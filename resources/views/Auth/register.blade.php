        ...
        <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
            <div>
                ...
                <p class="max-w-xl mt-3 text-gray-300">
                    {{ __('customLang.Sign Up, to start your adventure with us') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
        <div class="flex-1">
            ...
            <div class="text-center">
                <p class="mt-3 text-gray-500 dark:text-gray-300 text-xl">{{ __('customLang.Sign Up to access your account') }}</p>
            </div>
            ...
            <div class="mt-8">
                <form action="{{ route('register_post') }}" method="POST">
                    ...
                    {{-- Username --}}
                    <div>
                        <label for="username" class="block mb-2 text-sm text-gray-600 dark:text-gray-200">{{ __('customLang.Username') }}</label>
                        <input type="text" name="username" id="username" placeholder="{{ __('customLang.Username') }}" class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        @error('username')
                    ...
                    {{-- Email --}}
                    <div class="mt-6">
                        <label for="email" class="block mb-2 text-sm text-gray-600 dark:text-gray-200">{{ __('customLang.email') }}</label>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="password" name="password" id="password" placeholder="{{ __('customLang.password') }}" class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        @error('password')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                  ...
                  <div class="mt-6">
                        <div class="flex justify-between mb-2">
                            <label for="password_confirmation" class="text-sm text-gray-600 dark:text-gray-200">{{ __('customLang.Confirm Password') }}</label>
                        </div>

                        <input type="password" name="password_confirmation" id="password_confirmation" placeholder="{{ __('customLang.Confirm Password') }}" class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    ...
                    <div class="mt-6">
                        <button class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50" name="submit">
                            {{ __("customLang.signup") }}
                        </button>
                    </div>

                </form>

                <p class="mt-6 text-sm text-center text-gray-400">{{ __('customLang.Already have an account yet?') }} <a href="{{ route('login_view') }}" class="text-blue-500 focus:outline-none focus:underline hover:underline">{{ __('customLang.sign in') }}</a>.</p>
            </div>
        </div>
    </div>
</div>
