...
<div class="flex justify-center items-center py-6">
    <form action="{{ route('update.profile' , ['userId' => $user->id]) }}"  method="POST" enctype="multipart/form-data" class="w-4/12">
        ...
        {{-- Profile image --}}
        <div>
            <label for="profile_image" class="block mb-2 text-sm md:text-lg text-gray-600 dark:text-gray-200">Profile image</label>
        ...
        {{-- Bio --}}
        <div class="mt-6">
            <label for="bio" class="block mb-2 text-sm md:text-lg text-gray-600 dark:text-gray-200">Bio</label>
